	...
	static hf_register_info hf[] = {
		...
		{ &hf_vnc_vencrypt_version_ack,
		  { "VeNCrypt version ack", "vnc.vencrypt_version_ack",
		    FT_BOOLEAN, 4, TFS(&auth_result_tfs), 0x1,
		    NULL, HFILL }
		},
		{ &hf_vnc_vencrypt_auth_type,
		  { "VeNCrypt authentication type", "vnc.auth_type",
		    FT_UINT8, BASE_DEC, VALS(vnc_vencrypt_auth_types_vs), 0x0,
		    "VeNCrypt authentication type", HFILL }
		},
		{ &hf_vnc_vencrypt_num_auth_types,
		  { "VeNCrypt Number of supported authentication types", "vnc.num_auth_types",
		    FT_UINT32, BASE_DEC, NULL, 0x0,
		    "VeNCrypt Number of supported authentication types", HFILL }
		},
		{ &hf_vnc_vencrypt_auth_type_ack,
		  { "VeNCrypt Authorization type ack", "vnc.vencrypt_authtype_ack",
